...
<div class="content">
    ...
    <div class="danh-muc-sp" style="max-width: 1100px; margin: 40px auto; font-family: Arial, sans-serif;">
        <div class="row" style="margin-bottom: 25px;">
            <h2 style="text-align: center; color: #333;">Danh Sách Sản Phẩm Của Danh Mục: <span style="color: #007bff;">{{ $category->name }}</span></h2>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; background-color: #fff; box-shadow: 0 0 8px rgba(0, 0, 0, 0.1);">
            ...
            <tbody>
                ...
                <tr style="text-align: center; border-bottom: 1px solid #ccc;">
                    ...
                    <td style="padding: 8px;">
                        <a href="{{ url('/template/admin/product/form/add/'. $product->category_id) }}" style="background-color: #28a745; color: white; padding: 6px 12px; border-radius: 4px; text-decoration: none;">Thêm</a>
                    </td>
                    <td style="padding: 8px;">
