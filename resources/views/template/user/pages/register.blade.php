        ...
        <div class="row row-gap-4">
            <div class="col-xl-6">
                <div class="account account-1">
                    ...
                    <form action="shop-list-1.html" method="post" class="contact-form" novalidate="novalidate">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="input-block mb-16">
                                    <input type="email" name="mail" autocomplete="off" class="form-control" placeholder="Your Email">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <p class="light-gray mb-24">Your personal information helps improve your experience on our site, manage your account, and fulfill other purposes
                                    as detailed in our <span class="color-primary">privacy policy.</span></p>
                            </div>
                            <div class="col-sm-12">
