                        ...
                        <div class="row row-gap-3">
                            <div class="col-xl-6">
                                <div class="product-image-container bg-white">
                                    <div class="product-slider-asnav slick-initialized slick-slider">
                                        <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 20000px; transform: translate3d(0px, 0px, 0px);"><div class="nav-image slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="0">
                                            <img src="{{url('user')}}/media/products/nav-image-1.png" alt="">
                                        </div><div class="nav-image slick-slide slick-active" data-slick-index="1" aria-hidden="false" tabindex="0">
                                            <img src="{{url('user')}}/media/products/nav-image-2.png" alt="">
                                        </div><div class="nav-image slick-slide slick-active" data-slick-index="2" aria-hidden="false" tabindex="0">
                                            <img src="{{url('user')}}/media/products/nav-image-3.png" alt="">
                                        </div><div class="nav-image slick-slide slick-active" data-slick-index="3" aria-hidden="false" tabindex="0">
                                    ...
                                    <div class="product-slider slick-initialized slick-slider">
                                        <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 2056px;"><div class="detail-image slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 514px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;" tabindex="0">
                                            <img src="{{url('user')}}/media/products/large-image-1.png" alt="">
                                        </div><div class="detail-image slick-slide" data-slick-index="1" aria-hidden="true" style="width: 514px; position: relative; left: -514px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1">
                                            <img src="{{url('user')}}/media/products/large-image-2.png" alt="">
                                        </div><div class="detail-image slick-slide" data-slick-index="2" aria-hidden="true" style="width: 514px; position: relative; left: -1028px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1">
                                            <img src="{{url('user')}}/media/products/large-image-3.png" alt="">
                                        </div><div class="detail-image slick-slide" data-slick-index="3" aria-hidden="true" style="width: 514px; position: relative; left: -1542px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1">
                            ...
                            <div class="col-xl-6">
                                <div class="product-text-container bg-white br-20">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-16 mb-24">
                                        <h5 class="color-sec">★★★★<span class="light-gray">★</span>&nbsp;&nbsp;<span class="text-16 fw-400 dark-black">(02 Reviews)</span></h5>
                                    ...
                                    <div class="d-flex align-items-center gap-24 mb-24">
                                        ...
                                        <div class="drop-container bg-lightest-gray p-8-12 br-5">
                                            <div class="wrapper-dropdown black" id="dropdown02">
                                                ...
                                                <svg id="drp-arrow-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(#clip0_7951_48322)">
                                                        <g clip-path="url(#clip1_7951_48322)">
                                                            <path d="M0.0742188 4.01306L8.07424 11.987L16.0742 4.01306H0.0742188Z" fill="#141516"></path>
                                                        </g>
                                                    </g>
                                                    <defs>
                                                        ...
                                                        <clipPath id="clip1_7951_48322">
                                                            <rect width="16" height="16" fill="white" transform="translate(0.0742188)"></rect>
                                                        </clipPath>
                                                    </defs>
                                                </svg>
                                            ...
                                            <ul class="unstyled list">
                                                <li>
                                                    <label for="muhRadio1" class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                        <input type="radio" id="muhRadio1" name="muhRadio" class="radio-1" value="muhRadio1">
                                                    </label>
                                                </li>
                                                <li>
                                                    <label for="muhRadio2" class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                        <input type="radio" id="muhRadio2" name="muhRadio" class="radio-2" value="muhRadio2">
                                                    </label>
                                                </li>
                                                <li>
                                                    <label for="muhRadio3" class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                        <input type="radio" id="muhRadio3" name="muhRadio" class="radio-3" value="muhRadio3">
                                                    </label>
                                                </li>
                                                <li>
                                                    <label for="muhRadio4" class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                        <input type="radio" id="muhRadio4" name="muhRadio" class="radio-4" value="muhRadio4">
                                                    </label>
                                                </li>
                                                <li>
                                                    <label for="muhRadio5" class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                        <input type="radio" id="muhRadio5" name="muhRadio" class="radio-5" value="muhRadio5">
                                                    </label>
                                                </li>
                                                <li>
                                                    <label for="muhRadio6" class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                        <input type="radio" id="muhRadio6" name="muhRadio" class="radio-6" value="muhRadio6">
                                                    </label>
                                                </li>
                                                <li>
                                                    <label for="muhRadio7" class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                        <input type="radio" id="muhRadio7" name="muhRadio" class="radio-7" value="muhRadio7">
                                                    </label>
                                                </li>
                                            </ul>
                                        </div>
                                                        ...
                                                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <g clip-path="url(#clip0_7951_48348)">
                                                                <g clip-path="url(#clip1_7951_48348)">
                                                                    <path d="M19.5508 24.4844C19.3083 24.4844 19.0659 24.3908 18.8823 24.2042C18.5193 23.835 18.5243 23.2414 18.8935 22.8784L22.0446 19.7799C22.2199 19.6043 22.3164 19.3715 22.3164 19.1241C22.3164 18.8774 22.2205 18.6454 22.0462 18.4699L18.897 15.4064C18.0386 14.5069 19.2826 13.2294 20.2045 14.0624L23.3587 17.1309C23.3614 17.1336 23.3642 17.1362 23.3668 17.1389C23.8986 17.6691 24.1914 18.3741 24.1914 19.1242C24.1914 19.8742 23.8985 20.5792 23.3668 21.1093C23.3653 21.1108 23.3637 21.1123 23.3622 21.1139L20.208 24.2154C20.0255 24.3949 19.7881 24.4844 19.5508 24.4844ZM19.5508 19.9844H5.81641C2.71478 19.9844 0.191406 17.461 0.191406 14.3594V11.9688C0.237484 10.7262 2.02075 10.7271 2.06641 11.9688V14.3594C2.06641 16.4271 3.74866 18.1094 5.81641 18.1094H19.5508C20.7933 18.1555 20.7924 19.9387 19.5508 19.9844ZM23.2539 13.9375C22.7361 13.9375 22.3164 13.5178 22.3164 13V10.6094C22.3164 8.54164 20.6342 6.85939 18.5664 6.85939H4.83203C3.58947 6.81331 3.59041 5.03004 4.83203 4.98439H18.5664C21.668 4.98439 24.1914 7.50776 24.1914 10.6094V13C24.1914 13.5178 23.7717 13.9375 23.2539 13.9375ZM4.83194 11.1719C4.59634 11.1719 4.36052 11.0837 4.17831 10.9063L1.02409 7.83785C1.02133 7.83518 1.01861 7.83251 1.01594 7.82979C0.484234 7.29968 0.191406 6.59468 0.191406 5.84464C0.191406 5.09459 0.484234 4.38954 1.01594 3.85948C1.01748 3.85793 1.01898 3.85643 1.02053 3.85493L4.17475 0.7534C4.54394 0.3904 5.13752 0.395369 5.50052 0.764557C5.86352 1.13374 5.85855 1.72732 5.48936 2.09032L2.33823 5.18885C1.97884 5.53432 1.97809 6.15242 2.33655 6.49878L5.48575 9.56239C5.85686 9.92342 5.86502 10.5169 5.50398 10.8881C5.32028 11.077 5.07616 11.1719 4.83194 11.1719Z" fill="#141516"></path>
                                                                </g>
                                                            </g>
                                                            <defs>
                                                                <clipPath id="clip0_7951_48348">
                                                                    <rect width="24" height="24" fill="white" transform="translate(0.0820312 0.484375)"></rect>
                                                                </clipPath>
                                                                <clipPath id="clip1_7951_48348">
                                                                    <rect width="24" height="24" fill="white" transform="translate(0.191406 0.484375)"></rect>
                                                                </clipPath>
                                                            </defs>
                                                        </svg>
                                                    </a>
                                                ...
                                                <a href="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                        <g clip-path="url(#clip0_7951_48375)">
                                                            <path d="M3.76245 5.02094H0.75C0.491089 5.02094 0.28125 5.2309 0.28125 5.48969V15.5314C0.28125 15.7903 0.491089 16.0002 0.75 16.0002H3.76245C4.02136 16.0002 4.2312 15.7903 4.2312 15.5314V5.48969C4.2312 5.2309 4.02136 5.02094 3.76245 5.02094ZM3.2937 15.0627H1.21875V5.95844H3.2937V15.0627Z" fill="#006937"></path>
                                                            <path d="M2.25635 0.000183105C1.16724 0.000183105 0.28125 0.886169 0.28125 1.97504C0.28125 3.06415 1.16724 3.95001 2.25635 3.95001C3.34534 3.95001 4.2312 3.06403 4.2312 1.97504C4.2312 0.886169 3.34534 0.000183105 2.25635 0.000183105ZM2.25635 3.01251C1.6842 3.01251 1.21875 2.54718 1.21875 1.97504C1.21875 1.40302 1.6842 0.937683 2.25635 0.937683C2.82837 0.937683 3.2937 1.40302 3.2937 1.97504C3.2937 2.54718 2.82837 3.01251 2.25635 3.01251Z" fill="#006937"></path>
                                                            <path d="M11.2941 4.95465C10.5815 4.95465 9.87927 5.1264 9.25037 5.44769C9.229 5.20856 9.0282 5.02094 8.78345 5.02094H5.77075C5.51196 5.02094 5.302 5.2309 5.302 5.48969V15.5314C5.302 15.7903 5.51196 16.0002 5.77075 16.0002H8.78345C9.04236 16.0002 9.2522 15.7903 9.2522 15.5314V10.0085C9.2522 9.29803 9.83032 8.72003 10.5408 8.72003C11.2512 8.72003 11.8291 9.29803 11.8291 10.0085V15.5314C11.8291 15.7903 12.0391 16.0002 12.2979 16.0002H15.3104C15.5693 16.0002 15.7792 15.7903 15.7792 15.5314V9.43976C15.7792 6.96661 13.7672 4.95465 11.2941 4.95465ZM14.8417 15.0627H12.7667V10.0085C12.7667 8.78107 11.7682 7.78253 10.5409 7.78253C9.31335 7.78253 8.3147 8.78107 8.3147 10.0085V15.0627H6.23962V5.95844H8.3147V6.30475C8.3147 6.48505 8.41809 6.64935 8.58069 6.72736C8.74316 6.80536 8.93604 6.78314 9.07678 6.67047C9.71155 6.16132 10.4784 5.89215 11.2941 5.89215C13.2502 5.89215 14.8417 7.48358 14.8417 9.43976V15.0627Z" fill="#006937"></path>
                                                        </g>
                                                        <defs>
