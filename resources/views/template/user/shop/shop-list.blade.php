                                    ...
                                    <ul class="main-menu__list">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="dropdown">
                                                    <a href="javascript:void(0);" class="active">Shop List with Sidebar</a>
                                                    <ul class="sub-menu">
                                                        <li><a href="shop-list-sidebar-1.html" class="active">Shop List Sidebar 1</a></li>
                                                    </ul>
                                                </li>
