                ...
                <div class="container-fluid">
                    <div class="row row-gap-3">
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="cus-btn-arrow">Read More 
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="15" viewBox="0 0 20 15" fill="none">
                                            <path d="M13.3545 14.7476C13.3545 11.7476 16.1545 7.74756 19.3545 7.74756M19.3545 7.74756C17.5212 7.74756 13.3545 6.74756 13.3545 0.747559M19.3545 7.74756H0.354492" stroke="#0C0C0D" stroke-width="2"></path>
                                        </svg>
                                    </div>                
                                </div>
                            </a>
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <a href="blog-detail.html" class="blog-block bg-white m-0">
                                <div class="blog-image">
                                    <img src="{{url('user')}}/media/blogs/blog-5.png" alt="">
                                </div>
                                <div class="blog-content">
                                    <div class="d-flex align-items-center gap-16 mb-16">
                                        <img src="{{url('user')}}/media/icons/calender.png" alt="">
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <a href="blog-detail.html" class="blog-block bg-white m-0">
                                <div class="blog-image">
                                    <img src="{{url('user')}}/media/blogs/blog-6.png" alt="">
                                </div>
                                <div class="blog-content">
                                    <div class="d-flex align-items-center gap-16 mb-16">
                                        <img src="{{url('user')}}/media/icons/calender.png" alt="">
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <a href="blog-detail.html" class="blog-block bg-white m-0">
                                <div class="blog-image">
                                    <img src="{{url('user')}}/media/blogs/blog-7.png" alt="">
                                </div>
                                <div class="blog-content">
                                    <div class="d-flex align-items-center gap-16 mb-16">
                                        <img src="{{url('user')}}/media/icons/calender.png" alt="">
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <a href="blog-detail.html" class="blog-block bg-white m-0">
                                <div class="blog-image">
                                    <img src="{{url('user')}}/media/blogs/blog-8.png" alt="">
                                </div>
                                <div class="blog-content">
                                    <div class="d-flex align-items-center gap-16 mb-16">
                                        <img src="{{url('user')}}/media/icons/calender.png" alt="">
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <a href="blog-detail.html" class="blog-block bg-white m-0">
                                <div class="blog-image">
                                    <img src="{{url('user')}}/media/blogs/blog-9.png" alt="">
                                </div>
                                <div class="blog-content">
                                    <div class="d-flex align-items-center gap-16 mb-16">
                                        <img src="{{url('user')}}/media/icons/calender.png" alt="">
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <a href="blog-detail.html" class="blog-block bg-white m-0">
                                <div class="blog-image">
                                    <img src="{{url('user')}}/media/blogs/blog-10.png" alt="">
                                </div>
                                <div class="blog-content">
                                    <div class="d-flex align-items-center gap-16 mb-16">
                                        <img src="{{url('user')}}/media/icons/calender.png" alt="">
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <a href="blog-detail.html" class="blog-block bg-white m-0">
                                <div class="blog-image">
                                    <img src="{{url('user')}}/media/blogs/blog-11.png" alt="">
                                </div>
                                <div class="blog-content">
                                    <div class="d-flex align-items-center gap-16 mb-16">
                                        <img src="{{url('user')}}/media/icons/calender.png" alt="">
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                            <a href="blog-detail.html" class="blog-block bg-white m-0">
                                <div class="blog-image">
                                    <img src="{{url('user')}}/media/blogs/blog-12.png" alt="">
                                </div>
                                <div class="blog-content">
                                    <div class="d-flex align-items-center gap-16 mb-16">
                                        <img src="{{url('user')}}/media/icons/calender.png" alt="">
